...
if [[ ! -s reports/generated/pass111_rcc_pa_ipc4_seed0.json || ! -s reports/checkpoints/pass111_rcc_pa_ipc4_seed0.pt ]]; then
...
PYTHONPATH=src .venv/bin/python scripts/export_final_inshop_embeddings.py \
  --checkpoint reports/checkpoints/pass111_rcc_pa_ipc4_seed0.pt \
  --report reports/generated/pass111_rcc_pa_ipc4_seed0.json \
  --dataset-root /home/riomus/datasets/inshop_official_standard \
  --query-output reports/generated/pass111_rcc_pa_ipc4_seed0_query.npz \
  --gallery-output reports/generated/pass111_rcc_pa_ipc4_seed0_gallery.npz \
  --retrieval-output reports/generated/pass111_rcc_pa_ipc4_seed0_retrieval.json \
...
exec env PYTHONPATH=src .venv/bin/sfora image-end-to-end \
  ...
  --num-workers 8 \
  --seed 0 \
  --save-model-path reports/checkpoints/pass111_rcc_rcc_seed0.pt \
  --output reports/generated/pass111_rcc_rcc_seed0.json \
