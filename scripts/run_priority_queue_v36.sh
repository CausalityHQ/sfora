#!/usr/bin/env bash
# Faithful Cars196 RS@k reference reproduction registered in
...
log "priority queue v36 start: preregistered Cars196 RS@k reference reproduction"
run_arm cars rsatk recall_at_k_surrogate auto 0
log "priority queue v36 complete: stop for registered reproduction judgement"
