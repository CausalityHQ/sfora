...
LOG="${LOG:-logs/pass190_cebn_soft_seed0.log}"
REPORT="reports/generated/pass190_cebn_soft_seed0.json"
CHECKPOINT="reports/checkpoints/pass190_cebn_soft_seed0.pt"
