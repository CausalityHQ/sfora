...
# run
ssh researcher@gpu.example.com 'cd /home/researcher/group-learning && (uv run --group dev --extra research sfora imdb-encoder-train --limit-per-class 128 --group-size 4 --train-steps 80 --output reports/generated/imdb_encoder_training.json) || ([ -x .venv/bin/sfora ] && .venv/bin/sfora imdb-encoder-train --limit-per-class 128 --group-size 4 --train-steps 80 --output reports/generated/imdb_encoder_training.json)'
