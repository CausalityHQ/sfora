...
TRAINER_SHA=daae20d2a29fab8cd60d1974ed8f324e6e507b10f974b651468dbe1a58978651
...
trainer="$RUNS/train_inshop_siglip2_unseen_gallery_subspace.py"
...
updates=1000
if [[ "$mode" == smoke ]]; then
  arms=(control subspace)
  updates=17
fi
for arm in "${arms[@]}"; do
  output="$RUNS/sfora-inshop-subspace-$arm-179024-$updates-v1"
  test ! -e "$output"
