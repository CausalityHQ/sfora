#!/usr/bin/env bash
# Wait for the faithful Cars RS@k run, then perform strict preregistered analysis.
set -euo pipefail

PROJECT="${PROJECT:-/home/riomus/group-learning}"
ARTIFACT="$PROJECT/reports/generated/image_end_to_end_cars.rsatk.recall_at_k_surrogate.cars.official-ed05202.0c02a7e6e2a0_seed0.json"
