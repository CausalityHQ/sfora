...
PARALLEL_MODE = int(os.environ.get("SFORA_PARALLEL_MODE", "0"))
PRECOMPUTE = int(os.environ.get("SFORA_PRECOMPUTE", "1"))
THREADS = int(os.environ.get("SFORA_THREADS", "20"))
...
def main() -> None:
    ...
    index.use_precomputed_table = PRECOMPUTE
    if PRECOMPUTE:
    ...
    os.close(direct_fd)
    payload = {
        "schema": "sfora-stock-ivfpq-direct-refine-threadmatched-v1",
