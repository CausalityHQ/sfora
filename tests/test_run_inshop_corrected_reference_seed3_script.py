"""Behavioral lock for the corrected In-Shop seed-3 reference runner."""
...
def test_seed3_runner_executes_locked_recipe_and_validates_final_artifacts(
    tmp_path: Path,
) -> None:
    ...
    runner = (
        ...
        / "scripts"
        / "run_inshop_corrected_reference_seed3.sh"
    )
    env = os.environ | {
    ...
    assert (project / "reports/generated/inshop_corrected_pa_seed3.json").is_file()
    assert (project / "reports/checkpoints/inshop_corrected_pa_seed3.pt").is_file()
