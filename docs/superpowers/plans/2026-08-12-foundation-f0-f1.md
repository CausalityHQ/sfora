...
durable receipt root rather than a report-selected directory. Authenticate the
separate published-metric register before that evaluation, then call
`cross_check_published_metrics` afterward. Publish both
