"""Pinned BN-Inception used by the official Proxy Anchor implementation.

Adapted from sung-yeon-kim/Proxy-Anchor-CVPR2020 revision
51db57031e38f75c03f69bbdfad1a3233afd9787 under its MIT license.
"""
...
def build_bn_inception(
    *,
    ...
    """Build the authors' BN-Inception embedding model.

    The reference architecture always sums global average and maximum pooling.
    """
    if not add_gmp:
        raise ValueError("the official Proxy Anchor BN-Inception recipe requires GAP+GMP")
    return bn_inception(
        embedding_size=embedding_size,
        pretrained=pretrained,
        is_norm=True,
        bn_freeze=freeze_batch_norm_affine,
    )
